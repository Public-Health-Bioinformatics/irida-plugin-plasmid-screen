 ...
 */
public class PlasmidScreenPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType PLASMID_SCREEN = new AnalysisType("PLASMID_SCREEN");

	public PlasmidScreenPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		 ...
		 * 
		 * <pre>
		 * {@code <id>6ab85646-2aae-4c52-ae68-d6acbbfe6f1d</id>}
		 * </pre>
		 * 
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("6ab85646-2aae-4c52-ae68-d6acbbfe6f1d");
		}
		...
		public Optional<Color> getBackgroundColor() {
			return Optional.of(Color.decode("#f542b6"));
		}
		...
		public Optional<AnalysisSampleUpdater> getUpdater(MetadataTemplateService metadataTemplateService,
			...
			return Optional.of(new PlasmidScreenPluginUpdater(metadataTemplateService, sampleService, iridaWorkflowsService));
		}
	}
}
